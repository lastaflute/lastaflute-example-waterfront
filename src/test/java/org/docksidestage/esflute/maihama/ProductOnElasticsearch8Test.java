...
public class ProductOnElasticsearch8Test extends UnitWaterfrontTestCase {

    private static final Logger logger = LoggerFactory.getLogger(ProductOnElasticsearch8Test.class);
