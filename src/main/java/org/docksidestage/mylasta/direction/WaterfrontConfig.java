...
import org.docksidestage.mylasta.direction.WaterfrontEnv;
...
public interface WaterfrontConfig extends WaterfrontEnv {
    ...
    public static class SimpleImpl extends WaterfrontEnv.SimpleImpl implements WaterfrontConfig {
        ...
        public String getPagingPageSize() {
            return get(WaterfrontConfig.PAGING_PAGE_SIZE);
        }

        public Integer getPagingPageSizeAsInteger() {
            return getAsInteger(WaterfrontConfig.PAGING_PAGE_SIZE);
        }

        public String getPagingPageRangeSize() {
            return get(WaterfrontConfig.PAGING_PAGE_RANGE_SIZE);
        }

        public Integer getPagingPageRangeSizeAsInteger() {
            return getAsInteger(WaterfrontConfig.PAGING_PAGE_RANGE_SIZE);
        }

        public String getPagingPageRangeFillLimit() {
            return get(WaterfrontConfig.PAGING_PAGE_RANGE_FILL_LIMIT);
        }

        public boolean isPagingPageRangeFillLimit() {
            return is(WaterfrontConfig.PAGING_PAGE_RANGE_FILL_LIMIT);
        }
    }
}
