 ...
 * @author jflute
 */
public class WaterfrontSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public WaterfrontSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
