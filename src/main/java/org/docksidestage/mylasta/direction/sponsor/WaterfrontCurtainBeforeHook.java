 ...
 * @author jflute
 */
public class WaterfrontCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = WaterfrontUserTimeZoneProcessProvider.centralTimeZone;
