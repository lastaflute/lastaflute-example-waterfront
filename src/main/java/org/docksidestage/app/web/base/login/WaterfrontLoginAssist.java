 ...
 * @author jflute
 */
public class WaterfrontLoginAssist extends TypicalLoginAssist<Integer, WaterfrontUserBean, Member> // #change_it also UserBean
    ...
    //                                                                       =============
    @Override
    protected WaterfrontUserBean createUserBean(Member userEntity) {
        return new WaterfrontUserBean(userEntity);
    }

    @Override
    protected OptionalThing<String> getCookieRememberMeKey() {
        return OptionalThing.of(waterfrontConfig.getCookieRememberMeWaterfrontKey());
    }
    ...
    @Override
    protected void saveLoginHistory(Member member, WaterfrontUserBean userBean, LoginSpecifiedOption option) {
        asyncManager.async(() -> {
    ...
    //                                                                      ==============
    @Override
    protected Class<WaterfrontUserBean> getUserBeanType() {
        return WaterfrontUserBean.class;
    }
